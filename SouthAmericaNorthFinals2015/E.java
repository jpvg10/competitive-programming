...
//Available at: https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=866&page=show_problem&problem=4896
public class E {
	...
	public static void main(String[] args) throws IOException {
		...
		while((desc = br.readLine()) != null){
			...
			valuesD = new ArrayList<Integer>();
			valuesP = new ArrayList<Integer>();
	...
	private static void bfs(int s) {
		...
		weights.add(value);
		valuesD.add(currentP - currentD);
		valuesP.add(currentD - currentP);
	}
}